...
(function ($) {
    $.skEditor = function (box, options) {
        ...
        var group2 =
            '<div class="sk-btn-group">\
            <div class="sk-btn dropdown">\
                <button type="button" class="sk bold dropdown-toggle" id="dropdownMenuH' +
            id +
            '" title="Headings" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Headings </button>\
                <div class="dropdown-menu" aria-labelledby="dropdownMenuH' +
            id +
            '">\
                    <a class="dropdown-item sk heading" heading="h1" href="javascript:" style="padding:.25rem 1.25rem;"><h1 style="font-size:19px;font-weight:bold;">Heading 1</h1></a>\
                    <a class="dropdown-item sk heading" heading="h2" href="javascript:" style="padding:.25rem 1.25rem;"><h2 style="font-size:18px;font-weight:bold;">Heading 2</h2></a>\
            ...
            <div class="sk-btn dropdown">\
                <button type="button" class="sk bold dropdown-toggle" id="dropdownMenuF' +
            id +
            '" title="Font Sizes" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Font Sizes </button>\
                <div class="dropdown-menu" aria-labelledby="dropdownMenuF' +
            id +
            '">\
                    <a class="dropdown-item font-size" size="1" href="javascript:" style="padding:.25rem 1.25rem;">8pt</a>\
                    <a class="dropdown-item font-size" size="2" href="javascript:" style="padding:.25rem 1.25rem;">10pt</a>\
        ...
        var group3 =
            '<div class="sk-btn-group">\
                ...
                <div class="sk-btn dropdown">\
                    <button type="button" class="sk color" title="Text Color"><i class="fas fa-font fs-17"></i><span class="sk-preview" style="background-color:rgb(0,0,0);"></span></button>\
                    <button type="button" class="sk dropdown-toggle" id="dropdownMenuColor' +
            id +
            '" data-bs-toggle="dropdown" aria-expanded="false">\
                        <span class="sr-only">Toggle Dropdown</span>\
                    </button>\
                    <div class="dropdown-menu p-2" aria-labelledby="dropdownMenuColor' +
            id +
            '">\
                        <div class="color-picker" acp-color="#000000" acp-show-rgb="no" acp-show-hsl="no" acp-show-hex="yes" acp-palette="PALETTE_MATERIAL_CHROME" acp-palette-editable></div>\
                        <button type="button" class="btn btn-secondary btn-sm btn-block mt-2" title="No color">No color <i class="fas fa-times"></i></button>\
                ...
                <div class="sk-btn dropdown">\
                    ...
                    <button type="button" class="sk dropdown-toggle" id="dropdownMenuBgColor' +
            id +
            '" data-bs-toggle="dropdown" aria-expanded="false">\
                        <span class="sr-only">Toggle Dropdown</span>\
                    </button>\
                    <div class="dropdown-menu p-2" aria-labelledby="dropdownMenuBgColor' +
            id +
            '">\
                        <div class="background-color-picker" acp-color="#000000" acp-show-rgb="no" acp-show-hsl="no" acp-show-hex="no" acp-palette="PALETTE_MATERIAL_CHROME" acp-palette-editable></div>\
                        <button type="button" class="btn btn-secondary btn-sm btn-block mt-2 sk no-background" title="No color">No background color <i class="fas fa-times"></i></button>\
        ...
        var group5 =
            '<div class="sk-btn-group">\
                <div class="sk-btn dropdown">\
                    <button type="button" class="sk list dropdown-toggle" id="dropdownMenuBullet' +
            id +
            '" data-bs-toggle="dropdown" aria-expanded="false" title="Bullet list"><i class="fas fa-list-ul fs-17"></i></button>\
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuBullet' +
            id +
            '">\
                        <a class="dropdown-item sk bullet" bullet="disc" cmd="insertUnorderedList" href="javascript:">Default</a>\
                        <a class="dropdown-item sk bullet" bullet="circle" href="javascript:">Circle</a>\
        ...
        var group9 =
            '<div class="float-right sk-full-screen"><div class="sk-btn"><button type="button" class="sk full-screen" title="Full Screen"><i class="fas fa-expand"></i></button></div></div>';
        var codeModal = $(
            '<div class="modal fade" id="sk-code-' +
                id +
                '" abindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">\
                <div class="modal-dialog modal-xl">\
                    <div class="modal-content">\
                        <div class="modal-header"><h5 class="p-0">Source Code</h5></div>\
                        <div class="modal-body"><textarea class="form-control" name="source_code" rows="30"></textarea></div>\
        ...
        var LinkModal = $(
            '<div class="modal fade" id="sk-link-' +
                id +
                '" abindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">\
            <div class="modal-dialog modal-xl">\
                <div class="modal-content">\
        ...
        var ImageModal = $(
            '<div class="modal fade" id="sk-image-manager-' +
                id +
                '" tabindex="-1" role="dialog" aria-labelledby="imageManagerTitle" aria-hidden="true">\
            <div class="modal-dialog modal-xl" role="document">\
                <div class="modal-content">\
                    <div class="modal-body">\
                        <div class="row">\
                        ...
                        <div class="row im-s">\
                            ...
                            <div class="col-lg-4 col-md-6 col-xs-12">\
                                <div class="form-group">\
                                    <label>title=""</label>\
                                    <input type="text" class="form-control" name="im_title" required="true">\
                                </div>\
                            </div>\
                            <div class="col-lg-4 col-md-6 col-xs-12"><div class="form-group"><label>class=""</label><input type="text" class="form-control" name="im_class"></div></div>\
                            <div class="col-lg-12 col-md-12 col-xs-12"><div class="form-group"><labrl></label>Hyperlink :</label><input type="text" class="form-control" name="hyperlink"></div></div>\
        ...
        var templateModal = $(
            '<div class="modal fade" id="sk-template-' +
                id +
                '" tabindex="-1" role="dialog" aria-labelledby="templateTitle" aria-hidden="true">\
            <div class="modal-dialog modal-lg" role="document">\
            <div class="modal-content">\
                <div class="modal-body">\
                <div class="row">\
        ...
        var addButton = $(
            '<div class="sk-footer"><button type="button" class="btn btn-secondary btn-block sk add" style="font-size:20px; border-radius:unset;">Add Template+</button></div>'
        );
        var imageArea =
            '<div class="sk-img img-p" class=" style="display:grid;" ><h5 style="margin:auto;">IMAGE</h5></div>';
        var removeButton =
            '\
        <div class="col-12 sk-panel">\
            <div class="sk-btn float-right mt-2">\
        ...
        area.find(".row").each(function (i, item) {
            ...
            countRow++;
            sortSelect +=
                '<option value="' + countRow + '">' + countRow + "</option>";
        });

        //================= Remove button & Drag button =================//
        var rows = area.find(".sk-body").find(".row");
        $.each(rows, function (k, v) {
            if ($(this).find(".sk-panel").length == 0)
        ...
        area.find(".sk.heading").click(function () {
            Heading(this);
            setTimeout(() => {
                formStorage();
            }, 1000);
        });
        area.find(".sk.text-indent").click(function () {
            TextIndent();
            setTimeout(() => {
                formStorage();
            }, 1000);
        ...
        AColorPicker.from(area.find(".color-picker")).on(
            "change",
            (picker, color) => {
                area.find(".sk-preview").css("background-color", color);
                document.getSelection();
                document.execCommand("foreColor", false, color);
            }
        );
        AColorPicker.from(area.find(".background-color-picker")).on(
            "change",
            (picker, color) => {
                document.getSelection();
                document.execCommand("backColor", false, color);
                // area.find('.sk-tools').next().find('.col-img').css('background-color',color);
                // area.find('.sk-tools').next().find('.col-txt').css('background-color',color);
            }
        );
        // area.find('.sk.code').click(function(){codeModal.find('textarea').html(area.find('.sk-tools').next().html().trim()); codeModal.modal('show')});
        ...
        const hyperLink = () => {
            ...
            if (sText.baseNode.nodeName == "#text" && sText != "") {
                document.execCommand(
                    "insertHTML",
                    false,
                    '<a href="https://www.example.com" target="_self" title="">' +
                        sText +
                        "</a>"
                );
            }
            current = $(sText.anchorNode?.parentNode);
            LinkModal.modal("show");
            LinkModal.find('input[name="hyperlink"]').val(
                $(sText.anchorNode?.parentNode).attr("href")
            );
            LinkModal.find('input[name="link-title"]').val(
                $(sText.anchorNode?.parentNode).attr("title")
            );
            // LinkModal.find('input[name="link-target"]').val($(sText.anchorNode?.parentNode).attr('title'))
            LinkModal.find('select[name="link-target"]').map(function () {
                if (
                    $(this).val() ==
                    $(sText.anchorNode?.parentNode).attr("target")
                ) {
                    $(this).attr("selected");
                }
            });
        ...
        area.find(".sk.link").click(function () {
            hyperLink();
        });
        area.find(".sk.reset").click(function () {
            area.find(".col-txt").each(function () {
                el = $(this).find("[style]");
        ...
        area.find(".sk.add").click(function () {
            templateModal.modal("show");
        });
        area.find(".sk.no-background").click(function () {
            document.getSelection();
            document.execCommand("backColor", false, "unset");
            // area.find('.sk-tools').next().find('.col-img').css('background-color','unset');
            // area.find('.sk-tools').next().find('.col-txt').css('background-color','unset');
        });
        //================= Add Row =================//
        ...
        templateModal.find(".select-template").click(function () {
            ...
            $(".border-selected").removeClass("border-selected");
            templateModal.modal("hide");
            area.find(".sk-body").animate(
                { scrollTop: area.find(".sk-body")[0].scrollHeight },
                800
            );
            // setTimeout(()=>{formStorage()},1000);
        });
        ...
        area.find(".sk.sort-select").each(function (i, e) {
            ...
            $(e)
                ...
                .each(function () {
                    let selected =
                        parseFloat($(this).val()) == no ? true : false;
                    if (selected === true) {
        ...
        const bodyToSort = area.find(".sk-body");
        var df = 0;
        area.find(".sk.sort-select").on("click", function () {
            df = parseFloat($(this).val());
        });
        area.find(".sk.sort-select").on("change", function () {
            let n = parseFloat($(this).val());
            var rows = bodyToSort.find(".row");
        ...
        area.on("click", ".sk-img", function () {
            ...
            if ($(this).find("img").length > 0) {
                ...
                if (image.attr("data-href") != "")
                    ts.find('input[name="hyperlink"]').val(
                        image.attr("data-href")
                    );
                imgCodeObj.attr(
                    "src",
                    ts.find('input[name="im_source"]').val()
                );
                imgCodeObj.attr(
                    "class",
                    ts.find('input[name="im_class"]').val()
                );
                if (ts.find('input[name="im_alt"]').val() != "")
                    imgCodeObj.attr(
                        "alt",
                        ts.find('input[name="im_alt"]').val()
                    );
                if (ts.find('input[name="im_title"]').val() != "")
                    imgCodeObj.attr(
                        "alt",
                        ts.find('input[name="im_title"]').val()
                    );
                if (ts.find('input[name="width"]').val() != "")
                    imgCodeObj.attr(
                        "width",
                        ts.find('input[name="width"]').val()
                    );
                if (ts.find('input[name="height"]').val() != "")
                    imgCodeObj.attr(
                        "height",
                        ts.find('input[name="height"]').val()
                    );

                imgCode.html(escapeHtml(imgCodeObj[0].outerHTML));
                if (image.parent().next().hasClass("img-caption")) {
                    ImageModal.find('input[name="im_caption"]').prop(
                        "checked",
                        true
                    );
                }
            ...
            ImageModal.on("click", ".im-select", function () {
                if ($(this).closest(".row").hasClass("im-f")) {
                    if (
                        $(this).closest(".row").find(".im-checked").length == 0
                    ) {
                        alert("กรุณาเลือกรูป");
                        return false;
                    }
                ...
                if ($(this).closest(".row").hasClass("im-s")) {
                    ...
                    required.map(function (k, v) {
                        ...
                        if (v.value == "") {
                            ...
                            error.push(v.getAttribute("name"));
                        } else {
                            v.classList.remove("is-invalid");
                            delete error[v.getAttribute("name")];
                        }
                    });
                    if (error.length < 1) {
                        if (
                            $(this)
                                .closest(".row")
                                .find('input[name="im_source"]')
                                .val() == ""
                        ) {
                            alert("กรุณาเลือกรูป");
                            return false;
                        }
                        const source = ImageModal.find(
                            'input[name="im_source"]'
                        );
                        $(this).find(".sk-img").find("h5").remove();
                        $(this).find(".sk-img").html("");
                        var c = ImageModal.find('input[name="im_class"]')
                                .val()
                                .split(" "),
                            imgC = null;
                        var fixC = "img-fluid";
                        let cf = Boolean;
                        let im_class = ImageModal.find(
                            'input[name="im_class"]'
                        );
                        const im_caption = ImageModal.find(
                            'input[name="im_caption"]'
                        );
                        for (i = 0; i < c.length; i++) {
                            cf = c[i] == fixC ? true : false;
                        }
                        if (
                            ImageModal.find('input[name="im_class"]').val() ==
                            ""
                        ) {
                            ImageModal.find('input[name="im_class"]').val(fixC);
                        } else {
                        ...
                        const imClass = ImageModal.find(
                            'input[name="im_class"]'
                        ).val();
                        const imWidth = ImageModal.find(
                            'input[name="im_width"]'
                        ).val();
                        const imHeight = ImageModal.find(
                            'input[name="im_height"]'
                        ).val();
                        const hyperlink = ImageModal.find(
                        ...
                        if (ImageModal.find('input[name="im_alt"]').val() != "")
                            newImg.attr(
                                "alt",
                                ImageModal.find('input[name="im_alt"]').val()
                            );
                        if (
                            ImageModal.find('input[name="im_title"]').val() !=
                            ""
                        )
                            newImg.attr(
                                "title",
                        ...
                        if (im_caption.is(":checked"))
                            if (
                                newImg.parent().parent().find(".img-caption")
                                    .length == 1
                            )
                                $(".img-caption");
                            else
                                $(
                                    '<div class="img-caption" contenteditable="true">Caption</div>'
                                ).insertAfter(newImg.parent());
                        else
                            newImg
                                .parent()
                                .parent()
                        ...
                        if (hyperlink != "")
                            newImg.attr("data-href", hyperlink);
                        // setTimeout(()=>{formStorage()},1000)
                        // console.log($(this).find('.sk-img'));
                        ImageModal.modal("hide");
                    }
        ...
        $(document).on("change keyup", 'input[name="im_source"]', function () {
            imgCodeObj.attr("src", ts.find('input[name="im_source"]').val());
            imgCode.html(escapeHtml(imgCodeObj[0].outerHTML));
        });
        $(document).on("keyup", 'input[name="im_class"]', function () {
            imgCodeObj.attr("class", ts.find('input[name="im_class"]').val());
            imgCode.html(escapeHtml(imgCodeObj[0].outerHTML));
        });
        $(document).on("keyup", 'input[name="im_alt"]', function () {
            imgCodeObj.attr("alt", ts.find('input[name="im_alt"]').val());
            imgCode.html(escapeHtml(imgCodeObj[0].outerHTML));
        });
        $(document).on("keyup", 'input[name="im_title"]', function () {
            imgCodeObj.attr("alt", ts.find('input[name="im_title"]').val());
            imgCode.html(escapeHtml(imgCodeObj[0].outerHTML));
        });
        $(document).on("keyup", 'input[name="width"]', function () {
            imgCodeObj.attr("width", ts.find('input[name="width"]').val());
            imgCode.html(escapeHtml(imgCodeObj[0].outerHTML));
        });
        $(document).on("keyup", 'input[name="height"]', function () {
            imgCodeObj.attr("height", ts.find('input[name="height"]').val());
            imgCode.html(escapeHtml(imgCodeObj[0].outerHTML));
        });
        ImageModal.on("click", ".btn-outline-dark", function () {
            ts.hide();
            tf.show();
            tu.hide();
        });
        ...
        ImageModal.on("click", ".im-cancel", function () {
            ...
            if ($(this).closest(".row").hasClass("im-u")) {
                tf.show();
                tu.hide();
            }
        });
        ...
        ImageModal.on("click", ".im-btn-choose", function () {
        ...
        $(document).on("change", 'input[name="im_upload"]', function () {
            ...
            $.each(this.files, function (i, v) {
                ...
                tu.find(".im-content-upload").html("");
                let thumbanil = $(
                    '<div class="col-lg-12 p-0"><div class="im-preview im-item sk-img rounded"><div class="im-image rounded-left"></div><div class="im-details"><div class="im-progress progress"><div class="progress-bar" role="progressbar" style="width: 0%;" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">0%</div></div></div><div class="im-action"><button class="btn btn-danger btn-sm"><i class="far fa-trash-alt"></i></button></div></div></div>'
                );
                var reader = new FileReader();
                reader.readAsDataURL(v);
                let size = v.size;
                ...
                thumbanil
                    .find(".im-details")
                    .prepend(
                        '<div class="im-name text-left"><span alt="' +
                            name +
                            '">' +
                            name +
                            "</span></div>"
            ...
            $.ajax({
                ...
                success: function (data) {
                    $.each(data, function (i, val) {
                        img = val.split("/");
                        i = img.length - 1;
                        tf.find(".im-content-image").append(
                            '<div class="im-image-grid"><img src="' +
                                val +
                                '" title="' +
                                img[i] +
        ...
        $(document).on("click", ".im-view", function () {
            ...
            else $(".im-image-grid").toggleClass("im-image-grid im-image-list");
        });
        ...
        ImageModal.on("click", ".im-refresh", function () {
            myFolder();
        });
        ImageModal.on("click", ".im-delete", function () {
            if ($(".im-checked").length > 0) {
                if (confirm("ลบรูปนี้ใช่หรือไม่!")) {
                    $.ajax({
                        method: "get",
                        url: `${prefix}/delete/profile-image`,
                        data: { u: $(".im-checked").find("img").attr("src") },
                        dataType: "JSON",
                        success: function (data) {
                            if (data === true) $(".im-checked").remove();
                        },
                    });
                }
            }
        ...
        $(document).on("submit", function (e) {
            ...
            if (window.location.href.indexOf("members") > -1) {
                text = document
                    .querySelector(`.sk-area[data-lang="${lang}"]`)
                    .querySelector(".sk-body").innerText;

                if (text !== "")
                    $(`textarea[name="detail_${lang}"]`).html(
                        text.replace(/\s+/g, " ")
                    );
            }
