                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="type" id="type" disabled>
                                                ...
                                                <option value="industry" @if($type == 'industry')selected @endif>Industry</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="industry" id="industry" disabled>
                                                ...
                                                @foreach ($industry as $v)
                                                    <option value="{{ $v->id }}" @if($data->industry_id == $v->id)selected @endif>{{ $v->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body p-2">
                                                <div class="form-group m-0">
                                                    ...
                                                    <div class="input-group input-group-sm mb-2">
                                                        ...
                                                        <input class="form-control" id="icon" type="text" name="icon" @if($type == 'product')disabled @endif value="{{ $data->icon }}">
                                                    </div>
