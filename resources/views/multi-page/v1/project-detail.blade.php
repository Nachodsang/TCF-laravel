          ...
          <div class="row justify-content-center">
            <div class="col-lg-8 wow zoomIn" data-wow-delay="0.1s">
              <div class="img-s mt-5 mt-lg-0">
                <img src="images/project-02.jpg" class="img-fluid">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container-fluid section ">
        ...
        <div class="row justify-content-center mt-4">
          <div class="col-lg-4 mb-4">
            <img src="images/project-04.jpg" class="img-fluid">
            <small>Dsign Toluca</small>
          </div>
          <div class="col-lg-4 mb-4">
            <img src="images/project-05.jpg" class="img-fluid">
               ...
               <?php for($i=1;$i<=6;$i++){ ?>
                <div class="item">
                  <div class="gallery-wrap py-4">
                    <img src="images/project-0<?=$i?>.jpg" class="img-fluid">
                  </div>
                </div>
                <?php } ?>
              </div>
