            ...
            <div class="col-md-12 text-center">
                ...
                <ul class="footer-social p-0">
                    <li class="animate"><a @if ($social->fb) href="{{ $social->fb }}" @endif
                            data-toggle="tooltip" data-placement="top" title="" data-original-title="Facebook"><svg
                    ...
                    <li class="animate"><a @if ($social->twitter) href="{{ $social->twitter }}" @endif
                            ...
                            data-original-title="Twitter"><svg xmlns="http://www.w3.org/2000/svg" height="1em"
