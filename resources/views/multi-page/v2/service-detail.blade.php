...
<head>
    ...
    <base href="{{ url('/') }}">
    <title>Services - TCF Thailand</title>
    ...
    <meta name="keywords"
        content="accounting consulting firms in Thailand, consulting firm in Thailand, cpa firm in Thailand, {{ $detail->seo_keyword }} ">
    <meta name="description"
        content="Accounting Consulting Firms in Thailand: TCF Thailand provides professional services in the fields of Accounting, Taxation, Payroll, Audit, HR, Legal Services. {{ $detail->seo_description }}" />
